...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\">\n	<img class=\"img-rounded\" data-url=\"/";
  ...
  buffer += escapeExpression(stack1)
    + "?size=";
  if (helper = helpers.thumbSize) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.thumbSize); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\" />\n	<small>"
